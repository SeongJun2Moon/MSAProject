...
const Fashion = () => {
    ...
    return (
    <>
        옷은 1부터 20까지 : <input type="text" name="id1" onChange={onChange} /><br/>
        <button onClick={onClick_get}> GET </button><br/>
        옷은 1부터 20까지 : <input type="text" name="id2" onChange={onChange} /><br/>
